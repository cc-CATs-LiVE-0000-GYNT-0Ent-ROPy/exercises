...
and Os are in the board, to know whether player 1 or player 2 
...
user experience if the row counts and column counts start at 1. This 
is not required, but whichever way you choose to implement this, it 
