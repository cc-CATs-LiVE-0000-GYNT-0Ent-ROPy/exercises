if __name__ == "__main__":
  ...
  r = 100
  c = 0
  print("to high (h) or to low (l) or your number?")
  while l <= r:
    #print()
    c += 1
    m = r - (r-l)//2
    ...
    if u == "l":
      ...
      print("it take {} times to guess".format(c))
      break
  if l > r:
    print("are you sure about number? is number out of bound 0 - 100?")
...
have in your head a number between 0 and 100. The program will guess 
a number, and you, the user, will say whether it is too high, 
...
strategy might be to guess 50 (right in the middle of the range), and 
then increase / decrease by 1 as needed. After you’ve written the 
program, try to find the optimal strategy! (We’ll talk about what is 
